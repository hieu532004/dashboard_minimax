const LICENSE_KEY_PATTERN = /^(ASE|AVY|BRP|ELB)(?:-[A-Z2-7]{5}){5}$/;

const LICENSE_PRODUCTS = Object.freeze({
  ASE: "Auto Scene Alternator",
  AVY: "AutoVideo AI",
  BRP: "Beautiful Reup",
  ELB: "TH Elevenlab studio",
});
...
export function isLegacyDesktopLicenseKey(value) {
  return /^(ASE|AVY|BRP)(?:-[A-Z2-7]{5}){5}$/.test(normalizeLicenseKey(value));
}
