...
- `POST /api/license/validate`: endpoint công khai cho desktop app; nhận key
  `ASE-...`, `AVY-...`, `BRP-...` hoặc `ELB-...` và chỉ trả trạng thái của đúng
  key đó. TH Elevenlab studio dùng mã máy `ELB-...` qua HTTPS để mở khóa tool.
